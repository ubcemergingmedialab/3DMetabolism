var View = (function() {
  ...
  var nodes = {
    glucose: new Node(new THREE.Vector3(0, 10, 0), "glucose", ""),
    glucose_6_phosphate: new Node(new THREE.Vector3(0, 9, 0), "glucose 6-phosphate", ""),
    fructose_6_phosphate: new Node(new THREE.Vector3(0, 8, 0), "fructose 6-phosphate", ""),
    fructose_1_6_biphosphate: new Node(new THREE.Vector3(0, 7, 0), "fructose 1,6-biphosphate"),
    dihydroxyacetone_phosphate: new Node(new THREE.Vector3(-1, 6.5, 0), "dihydroxyacetone phosphate", true),
    glycerol_3_phosphate: new Node(new THREE.Vector3(-2, 6, 0), "glycerol 3-phosphate", true),
    glycerol: new Node(new THREE.Vector3(-2, 5, 0), "glycerol", true),
    glyceraldehyde_3_phosphate: new Node(new THREE.Vector3(0, 6, 0), "glyceraldehyde 3-phosphate"),
    _1_3_biphosphoglycerate: new Node(new THREE.Vector3(0, 5, 0), "1,3-biphosphoglycerate"),
    _3_phosphoglycerate: new Node(new THREE.Vector3(0, 4, 0), "3-phosphoglycerate"),
    _2_phosphoglycerate: new Node(new THREE.Vector3(0, 3, 0), "2-phosphoglycerate"),
    phosphoenolpyruvate_1: new Node(new THREE.Vector3(0, 2, 0), "phosphoenolpyruvate", true),
