...
/***/ (function (module, exports, __webpack_require__) {
        ...
        AFRAME.registerComponent('gui-button', {
            ...
            init: function init() {
                ...
                buttonContainer.setAttribute('class', 'gui-button');
                ...
                buttonEntity.setAttribute('class', 'gui-button');
            ...
            setText: function setText(newText) {
                ...
                textEntity.setAttribute('material', 'shader: standard; src: #' + this.canvas.id + '; transparent: true; opacity: 1; side:front;');
                textEntity.setAttribute('position', '0 0 0.041');
                textEntity.setAttribute('class', 'gui-text');
